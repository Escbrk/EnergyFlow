import{i as h}from"./vendor-CLTxG5yw.js";import{r as a,g as S,a as B,b as T}from"./main-BAiJBTmQ.js";const g="/EnergyFlow/assets/sprite-Cr8MNOq0.svg",i={query:"",category:"",searchTarget:""},y=(e=0,t=0,s=3)=>{const n=Math.floor(s/2);let r=e-n,l=e+n;r<1&&(r=1,l=s),l>t&&(l=t,r=t-s+1),r<1&&(r=1);const u=[];for(let c=r;c<=l;c++)u.push(c);const o=[];//! Left "..."
...
//# sourceMappingURL=render-BbTjHoxo.js.map
